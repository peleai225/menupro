        ...
        <aside :class="expanded ? 'w-64' : 'w-[72px]'"
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1 scrollbar-thin">
                ...
                <a href="{{ route('crm.dashboard') }}"
                   class="nav-item {{ request()->routeIs('crm.*') ? 'nav-active' : '' }}" title="CRM">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('super-admin.promo-banners.index') }}"
                   class="nav-item {{ request()->routeIs('super-admin.promo-banners*') ? 'nav-active' : '' }}" title="Bannières promo">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <nav class="fixed bottom-0 left-0 right-0 z-50 lg:hidden border-t shadow-[0_-4px_20px_rgba(0,0,0,0.12)]"
            ...
            <div x-show="more"
                ...
                <div class="grid grid-cols-3 sm:grid-cols-4 gap-3 mb-3">
                    ...
                    <a href="{{ route('crm.dashboard') }}" @click="more = false" class="flex flex-col items-center gap-1.5 p-3 rounded-xl hover:bg-neutral-50 {{ request()->routeIs('crm.*') ? 'bg-primary-50' : '' }}">
                        <span class="w-10 h-10 rounded-xl bg-emerald-100 flex items-center justify-center">
                    ...
                    <a href="{{ route('super-admin.promo-banners.index') }}" @click="more = false" class="flex flex-col items-center gap-1.5 p-3 rounded-xl hover:bg-neutral-50 {{ request()->routeIs('super-admin.promo-banners*') ? 'bg-primary-50' : '' }}">
                        <span class="w-10 h-10 rounded-xl bg-fuchsia-100 flex items-center justify-center">
