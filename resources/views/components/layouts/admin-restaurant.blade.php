    ...
    <div x-data="sidebar()" class="min-h-screen bg-neutral-100">
        ...
        <aside x-show="mobileOpen"
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1" @click="mobileOpen = false">
                ...
                <a href="{{ route('restaurant.reviews') }}" class="sidebar-item {{ request()->routeIs('restaurant.reviews*') ? 'sidebar-item-active' : '' }}"><svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg><span>Avis</span></a>
                @if(isset($restaurant) && $restaurant?->hasFeature('stock'))
                ...
                <a href="{{ route('restaurant.stock.fournisseurs.index') }}" class="sidebar-item {{ request()->routeIs('restaurant.stock.fournisseurs*') ? 'sidebar-item-active' : '' }}"><svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg><span>Fournisseurs</span></a>
            ...
            <div class="p-4 border-t border-neutral-800 flex-shrink-0">
                <div class="bg-neutral-500/10 border border-neutral-500/20 rounded-xl p-4">
                    <div class="flex items-center gap-2 text-neutral-400 text-sm font-medium"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Essai gratuit</div>
                </div>
            </div>
            @endif
        </aside>
