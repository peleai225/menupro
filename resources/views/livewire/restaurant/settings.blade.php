<div>
    ...
    @php
        ...
        $standHiddenTabs = ['verification', 'delivery', 'reservations', 'kitchen'];
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex gap-2">
                        <label class="btn btn-secondary flex-1 cursor-pointer justify-center min-h-[48px] px-4 py-3 flex items-center gap-2 touch-manipulation">
                            ...
                            <span wire:loading.remove wire:target="banner">{{ $existingBanner ? 'Changer la bannière' : 'Ajouter une bannière' }}</span>
                            <span wire:loading wire:target="banner" class="flex items-center gap-1.5">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="bg-emerald-50 border border-emerald-200 rounded-xl p-4">
                            <p class="text-sm text-emerald-800">
                                <strong>Comment l'utiliser :</strong> Envoyez ce lien au cuisinier ou scannez-le avec la tablette cuisine. Le lien reste valide en permanence — pas besoin de le regénérer sauf si vous voulez en invalider l'accès.
                            </p>
                        </div>
                    </div>
                </div>
