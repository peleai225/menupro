<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row gap-3">
        ...
        <a href="{{ route('crm.admin.export.reports') }}"
           class="inline-flex items-center gap-1.5 px-4 py-2.5 text-sm font-medium rounded-xl bg-orange-500/15 text-orange-400 border border-orange-500/30 hover:bg-orange-500/25 transition whitespace-nowrap">
