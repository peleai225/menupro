<div>
    ...
    <div class="flex items-center justify-center gap-3 mb-8">
        ...
        <div class="w-8 sm:w-12 h-px bg-orange-500/50"></div>
        <div class="flex items-center gap-2">
    ...
    <div class="bg-slate-800/60 border border-slate-700/50 rounded-2xl p-6 sm:p-8 shadow-2xl backdrop-blur-sm">
        <div class="text-center mb-6">
            ...
            <p class="text-slate-400 text-sm">Envoyez votre pièce d'identité pour activer votre compte agent.</p>
        </div>
        ...
        <form wire:submit="submit" class="space-y-5">
            ...
            <div>
                <label class="block text-sm font-medium text-slate-300 mb-2">
                    Pièce d'identité
                    <span class="text-slate-500 font-normal">(CNI, passeport, permis)</span>
                </label>
                <div class="relative">
                    <span class="absolute left-4 top-3.5 text-slate-500 pointer-events-none z-10">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <input type="file" wire:model="id_document" accept=".jpg,.jpeg,.png,.pdf"
                           class="w-full h-12 pl-12 pr-4 rounded-xl border border-slate-600 bg-slate-900/80 text-white
                                  file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-orange-500
                                  file:text-white file:font-medium file:cursor-pointer text-sm text-slate-400
                                  focus:outline-none focus:ring-2 focus:ring-orange-500">
                    <span wire:loading wire:target="id_document"
                          class="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-2 text-orange-400 text-sm">
            ...
            <button type="submit"
                    ...
                    class="w-full h-12 rounded-xl font-semibold bg-orange-500 hover:bg-orange-600 text-white
                           transition-all focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2
                           focus:ring-offset-slate-800 disabled:opacity-60 disabled:cursor-not-allowed
