<div class="bg-slate-800/60 border border-slate-600 rounded-2xl p-6 sm:p-8 shadow-2xl backdrop-blur">
    <div class="text-center mb-8">
        <div class="inline-flex items-center justify-center w-14 h-14 bg-orange-500/20 rounded-2xl mb-4">
    ...
    <form wire:submit="submit" class="space-y-5">
        ...
        {{-- Email --}}
        <div>
            <label for="email" class="block text-sm font-medium text-slate-300 mb-2">Adresse email (Gmail ou autre)</label>
            <div class="relative">
                <span class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 pointer-events-none">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="password" id="password_confirmation" wire:model="password_confirmation"
                           class="w-full h-12 pl-12 pr-4 rounded-xl border border-slate-600 bg-slate-900/80 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all"
                           placeholder="Réécrivez le mot de passe" autocomplete="new-password">
                </div>
            </div>
        </div>
