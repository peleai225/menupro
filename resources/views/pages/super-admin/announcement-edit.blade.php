<x-layouts.admin-super title="Modifier l'annonce">
    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            ...
            <p class="text-neutral-400 mt-1">{{ $announcement->title }}</p>
        </div>
    </div>
    ...
    <form action="{{ route('super-admin.announcements.update', $announcement) }}" method="POST" class="max-w-3xl">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-neutral-800/50 border border-neutral-700 rounded-xl p-6 space-y-5">
                ...
                <div>
                    ...
                    <textarea name="content" rows="5" required
                              class="w-full px-4 py-3 bg-neutral-700 border border-neutral-600 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-primary-500 resize-none">{{ old('content', $announcement->content) }}</textarea>
                </div>
            </div>
            ...
            <!-- Scheduling -->
            <div class="bg-neutral-800/50 border border-neutral-700 rounded-xl p-6">
                <h3 class="text-sm font-medium text-neutral-300 mb-4">Planification</h3>
            ...
            <div class="bg-neutral-800/50 border border-neutral-700 rounded-xl p-6 space-y-4">
                ...
                <label class="flex items-center justify-between p-4 bg-neutral-700/50 rounded-xl cursor-pointer">
                    <div>
                        ...
                        <p class="text-sm text-neutral-400">L'annonce sera visible</p>
                    </div>
                ...
                <label class="flex items-center justify-between p-4 bg-neutral-700/50 rounded-xl cursor-pointer">
                    <div>
                        ...
                        <p class="text-sm text-neutral-400">L'annonce apparaîtra sur le dashboard</p>
                    </div>
                ...
                <label class="flex items-center justify-between p-4 bg-neutral-700/50 rounded-xl cursor-pointer">
                    <div>
                        ...
                        <p class="text-sm text-neutral-400">Les utilisateurs peuvent fermer l'annonce</p>
                    </div>
