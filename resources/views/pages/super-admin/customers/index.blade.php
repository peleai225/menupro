            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-neutral-100">
                        ...
                        <tr class="hover:bg-neutral-50/50">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-1">
                                    <a href="{{ route('super-admin.customers.show', $customer->id) }}" class="p-1.5 rounded-lg hover:bg-neutral-100 text-neutral-500" title="Voir détail">
                        ...
                        @empty
                        <tr><td colspan="8" class="px-4 py-12 text-center text-neutral-400">Aucun client trouvé.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
