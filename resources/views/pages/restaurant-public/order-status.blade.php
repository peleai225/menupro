<x-layouts.restaurant-public :restaurant="$restaurant" :hide-header="true">
    <div class="min-h-screen bg-neutral-50 py-8">
        <div class="max-w-2xl mx-auto px-4">
            ...
            <!-- Order Details -->
            <div class="card p-6 mb-6">
                <h2 class="font-semibold text-neutral-900 mb-4">Détails de la commande</h2>
                ...
                <div class="divide-y divide-neutral-100">
                    ...
                    <div class="py-3 flex items-center justify-between">
                        <div class="flex-1">
                            ...
                            @if($item->options)
                                <p class="text-xs text-neutral-500 mt-0.5">{{ $item->options }}</p>
                            @endif
                            <span class="text-neutral-500 text-sm ml-2">× {{ $item->quantity }}</span>
                        </div>
                        <span class="font-medium text-neutral-900">{{ number_format($item->total, 0, ',', ' ') }} F</span>
                    </div>
                    @empty
                ...
                <div class="border-t border-neutral-200 mt-4 pt-4">
                    ...
                    <div class="flex items-center justify-between pt-2 border-t border-neutral-200">
                        ...
                        <span class="text-xl font-bold text-primary-600">{{ number_format($order->total, 0, ',', ' ') }} F</span>
                    </div>
                </div>
            </div>
            ...
            <div class="card p-6 mb-6">
                ...
                <div class="flex flex-col items-center gap-4">
                    @php
                        $trackingUrl = route('r.order.status', [$restaurant->slug, $order]);
                ...
                <div class="card p-6 mb-6 bg-gradient-to-r from-primary-50 to-secondary-50 border-2 border-primary-200">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <a href="{{ route('r.review.create', [$restaurant->slug, $order]) }}" 
...
<script>
    ...
    (function() {
        ...
        const statusUrl = `{{ route('r.order.status.json', [$restaurant->slug, $order]) }}`;
