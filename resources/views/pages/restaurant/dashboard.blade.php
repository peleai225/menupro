            ...
            <div class="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                ...
                <div class="flex flex-wrap gap-3">
                    <a href="{{ route('restaurant.orders') }}"
                       class="inline-flex items-center justify-center gap-2 px-5 py-3 w-full sm:w-auto bg-white/20 backdrop-blur hover:bg-white/30 rounded-xl font-medium transition-all">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @if($restaurant->slug)
                        <a href="{{ route('r.menu', $restaurant->slug) }}" target="_blank"
                           class="inline-flex items-center justify-center gap-2 px-5 py-3 w-full sm:w-auto bg-white text-primary-600 rounded-xl font-semibold hover:bg-primary-50 transition-all shadow-lg">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
