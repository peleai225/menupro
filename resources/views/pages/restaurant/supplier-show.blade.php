<x-layouts.admin-restaurant title="Fournisseur — {{ $supplier->name }}">
    ...
    <div class="flex items-center justify-between gap-4 mb-8">
        <div class="flex items-center gap-4">
            <a href="{{ route('restaurant.stock.fournisseurs.index') }}" class="p-2 hover:bg-neutral-100 rounded-lg">
        ...
        <div class="flex items-center gap-2">
            ...
            <form action="{{ route('restaurant.stock.fournisseurs.destroy', $supplier) }}" method="POST"
                    ...
                    <div class="divide-y divide-neutral-100">
                        ...
                        <div class="px-5 py-3 flex items-center justify-between gap-4">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                @endif
                                <form action="{{ route('restaurant.stock.suppliers.unlink-ingredient', [$supplier, $ingredient->id]) }}"
    ...
    <div id="linkIngredientModal" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl p-6 w-full max-w-md">
            ...
            <form action="{{ route('restaurant.stock.suppliers.link-ingredient', $supplier) }}" method="POST">
                @csrf
