        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-neutral-200 p-6">
                ...
                <form x-data="{ adding: false, newName: '' }"
                    ...
                    <button type="submit" :disabled="adding" class="btn btn-primary w-full sm:w-auto whitespace-nowrap flex items-center justify-center gap-2">
                            ...
                            <div class="flex items-center gap-3 p-3 bg-neutral-50 rounded-xl group"
                                ...
                                <div class="flex items-center gap-1 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity" x-show="!editing">
                                    <button @click="editing=true"
                                            class="w-11 h-11 sm:w-7 sm:h-7 rounded-lg bg-neutral-200 hover:bg-neutral-300 flex items-center justify-center text-neutral-600 transition-colors"
                                            title="Renommer">
                                    ...
                                    <form method="POST" action="{{ route('restaurant.rooms.destroy', $room) }}"
                                        ...
                                        @csrf @method('DELETE')
                                        <button type="submit"
                                                class="w-11 h-11 sm:w-7 sm:h-7 rounded-lg bg-red-100 hover:bg-red-200 flex items-center justify-center text-red-600 transition-colors"
                                                title="Supprimer">
