        ...
        <div class="w-full max-w-sm">
            <div class="text-center mb-8">
                ...
                <p class="text-slate-400 text-sm leading-relaxed">
                    ...
                    Vous recevrez un lien sur votre <strong class="text-white">WhatsApp</strong> pour définir votre mot de passe et accéder à votre espace.
                </p>
            </div>
            ...
            <div class="space-y-3 mb-8">
                ...
                <div class="flex items-center gap-3 px-4 py-3 rounded-2xl border border-slate-700/60 bg-slate-800/40">
                    ...
                    <p class="text-slate-300 text-sm">Lien de connexion envoyé sur WhatsApp</p>
                </div>
                <div class="flex items-center gap-3 px-4 py-3 rounded-2xl border border-slate-700/60 bg-slate-800/40">
                    <div class="w-8 h-8 rounded-xl bg-slate-700/60 flex items-center justify-center shrink-0">
