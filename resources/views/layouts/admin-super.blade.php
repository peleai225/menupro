            ...
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 overflow-y-auto py-6 px-3 space-y-2">
                    ...
                    <a href="{{ route('super-admin.orders.index') }}"
                       class="sidebar-item {{ request()->routeIs('super-admin.orders*') ? 'sidebar-item-active' : '' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('super-admin.deliveries.index') }}"
                       class="sidebar-item {{ request()->routeIs('super-admin.deliveries*') ? 'sidebar-item-active' : '' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0"/>
                        </svg>
                        <span x-show="expanded" x-transition class="whitespace-nowrap">Livraisons</span>
                    </a>
