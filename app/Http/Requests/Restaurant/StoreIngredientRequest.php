...
class StoreIngredientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'max_quantity' => ['nullable', 'numeric', 'min:0', 'gt:min_quantity'],
    ...
    public function messages(): array
    {
        return [
            ...
            'current_quantity.required' => 'La quantité actuelle est obligatoire.',
            'current_quantity.min' => 'La quantité ne peut pas être négative.',
            'min_quantity.required' => 'Le seuil d\'alerte est obligatoire.',
            'min_quantity.min' => 'Le seuil ne peut pas être négatif.',
            'max_quantity.gt' => 'La capacité max doit être supérieure au seuil minimum.',
            'unit_cost.required' => 'Le coût unitaire est obligatoire.',
